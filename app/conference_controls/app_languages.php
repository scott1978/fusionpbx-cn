...
$text['description-conference_controls']['zh-cn'] = "呼叫控制允许为操作分配数字。它们可用于在电话会议期间静音、取消静音或其他操作。";
...
$text['description-control_enabled']['zh-cn'] = "设置控制的状态。";
...
$text['title_description-conference_control_detail']['zh-cn'] = "呼叫控制允许为操作分配数字。它们可用于在电话会议期间静音、取消静音或其他操作。";
