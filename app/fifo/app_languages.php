...
$text['title-queue_detail_edit']['zh-cn'] = "编辑队列详细信息";
...
$text['title-queue_add']['zh-cn'] = "添加队列";
...
$text['option-anti-action']['zh-cn'] = "反操作";
...
$text['label-agent_queue_extension']['zh-cn'] = "队列分机号";
...
$text['label-agent_loginout_extension']['zh-cn'] = "登录/注销分机号";
...
$text['header-queue_edit']['zh-cn'] = "编辑队列";
...
$text['header-queue_detail_edit']['zh-cn'] = "编辑队列详细信息";
...
$text['header-queue_add']['zh-cn'] = "添加队列";
...
$text['header-conditions_and_actions']['zh-cn'] = "条件和措施";
...
$text['description-queues']['zh-cn'] = "队列用于设置呼叫者的等候队列。也称为FIFO队列。";
...
$text['description-queue_edit']['zh-cn'] = "队列用于设置呼叫者的等候队列。也称为FIFO队列。";
...
$text['description-queue_add']['zh-cn'] = "简单地说，队列是一种模式，供呼叫者等待，直到有人可以接电话。也称为FIFO队列。";
...
$text['description-name']['zh-cn'] = "队列将被分配的名称。";
...
$text['description-continue']['zh-cn'] = "在大多数情况下，继续应设置为否。";
...
$text['description-conditions_and_actions']['zh-cn'] = "拨号计划中使用以下条件、操作和反操作来引导呼叫流。每个操作都按顺序进行处理，直到到达操作dialplan_detail_tag，该操作告诉要执行的操作。对于给定的分机，您不仅限于一个条件或操作dialplan_detail_tag。";
...
$text['description-agent_queue_extension']['zh-cn'] = "代理拨打的分机号码，用于等待呼叫进入队列，或接听队列中的呼叫。代理将听到暂停音乐，直到呼叫者进入队列并接通呼叫.";
...
$text['description-agent_loginout_extension']['zh-cn'] = "代理使用此分机号登录或注销队列。在提示下，拨1登录，拨2注销。登录后，代理将准备好接收来自队列的呼叫。";
