...
$text['title_description-number_translations']['zh-cn'] = '使用此选项使用正则表达式将数字从原始数字转换为新数字.';
...
$text['description-number_translation_detail_replace']['zh-cn'] = '输入号码转换详细信息更换.';
...
$text['label-number_translation_details']['zh-cn'] = '详细';
