...
$text['title-access_control']['zh-cn'] = "访问权限控制";
...
$text['title_description-access_controls']['zh-cn'] = "访问控制列表可以允许或拒绝IP地址范围.";
...
$text['description-node_cidr']['zh-cn'] = "输入IP网段.";
