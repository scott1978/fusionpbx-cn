...
$text['description-recording']['zh-cn'] = "录音的名称 (未解析).";
...
$text['description-file']['zh-cn'] = "文件名称. 示例.wav";
...
$text['description']['zh-cn'] = "拨打 *732 创建录音，或（为获得最佳效果）上传 16 位 8khz/16khz 单声道 WAV 文件.";
