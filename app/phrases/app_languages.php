...
$text['header-edit_phrase']['zh-cn'] = "编辑短路";
...
$text['description-structure']['zh-cn'] = "定义构成短语的各个组成部分.";
...
$text['description-phrases']['zh-cn'] = "创建要按顺序播放的音频文件短语.";
...
$text['description-name']['zh-cn'] = "短路的名称 (示例: 'xyz_audio')";
