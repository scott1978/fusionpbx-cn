...
$text['title-user_edit']['zh-cn'] = "编辑用户";
...
$text['title-user_import']['zh-cn'] = "导入用户";
...
$text['description-users']['zh-cn'] = "添加、编辑、删除和搜索用户. ";
...
$text['message-green_border_passwords_match']['zh-cn'] = "绿色字段边框表示键入的密码匹配.";
